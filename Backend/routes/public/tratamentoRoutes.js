...
import * as tratamentoController from '../../controllers/public/tratamentoController.js';
 ...
 *         description: Lista todas as cidades
  */
router.get('/', tratamentoController.getTodasCidades);
 ...
 *         description: retorna uma cidade pelo id especificado
  */
router.get('/:id', tratamentoController.getCidadePorId);
