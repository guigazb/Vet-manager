import * as funcionarioModel from '../../models/public/funcionarioModel.js'
...
export const getTodosGruposPermissao = async (req, res) => {
    try {
        ...
        const grupoPermissoes = await funcionarioModel.getTodosGruposPermissao(sortCampo, sortOrdem);
...
export const getTodaspermissoesGrupoParaDatagrid = async (req, res) => {
    try {
        ...
        const permissaoGrupoDG = await funcionarioModel.getTodaspermissoesGrupoParaDatagrid();
...
export const getPermissoesGrupoParaDatagridMUI = async (req, res) => {
  try {
    const permissaoGrupoDGMUI = await funcionarioModel.getPermissoesGrupoParaDatagridMUI();
...
export const getGrupoPermissaoPorId = async (req, res) => {
    try {
        ...
        const grupoPermissaoPorId = await funcionarioModel.getGrupoPermissaoPorId(id);
...
export const getPermissaoPorGrupoId = async (req, res) => {
    try {
        const id = req.params.id
        const permissoesGrupoId = await funcionarioModel.getPermissaoPorGrupoId(id);
...
export const inserirGrupoPermissao = async (req, res) => {
    ...
    try {
        ...
        const novaoGrupoPermissao = await funcionarioModel.inserirGrupoPermissao(nome, ordem);
...
export const atualizarGrupoPermissao = async (req, res) => {
    ...
    try {
        ...
        const grupoPermissaoAtualizada =
            await funcionarioModel.atualizarGrupoPermissao(
                id, nome, ordem, ativo
            );
...
export const excluirPermissao = async (req, res) => {
    try {
        const id = req.params.id;
        const grupoPermissaoExcluida = await funcionarioModel.excluirPermissao(id);
