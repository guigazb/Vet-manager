...
import SearchModal from '../geral/ModalSearch';
...
import ThemeToggle from '../geral/ThemeToggle';
        ...
        <div className={
          ...
          <div className="flex">
            ...
            <div className="text-sky-800 font-bold">
              <span className="hidden md:inline lg:inline text-xl">
                Gestão de Ciclo BPM do HU-UFMA&nbsp;&nbsp;
              </span>
              <span className="hidden sm:inline md:hidden text-lg">
                Gestão Ciclo BPM&nbsp;&nbsp;
              </span>
              <span className="inline sm:hidden text-md">
                Ciclo BPM&nbsp;&nbsp;
              </span>
            </div>
