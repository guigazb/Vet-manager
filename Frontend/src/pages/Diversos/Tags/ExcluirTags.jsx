...
const ExcluirTags = () => {
    ...
    const handleDeleteSubmit = async (e) => {
        ...
        try {
            await axios.delete(import.meta.env.VITE_API_URL_BACKEND + import.meta.env.VITE_API_URL_TAGS + '/' + id);
            ...
            toast.error('Erro ao tentar excluir a Tag', error);
        }
    };
    ...
    return (
        <MainLayout>
            <React.Fragment>
                ...
                <Actions breadcrumb="Início : Diversos" nomeSessao="Excluir Tag" hasAddViewButton={false} hasFilter={false} />
                ...
                <Modal modalAberto={modalAberto} onFechar={handleFecharModal}>
                    ...
                    <Modal.ModalCorpo>
                        Tem certeza que deseja excluir o registro <br />[<b>{formTag}</b>]?
                    </Modal.ModalCorpo>
                    <Modal.ModalRodape>
