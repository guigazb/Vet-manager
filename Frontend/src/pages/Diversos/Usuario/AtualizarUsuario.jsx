...
const AtualizarUsuario = () => {
    ...
    const handleIrPaginaModificarSenha = () => {
        navegar(routes.diversos_usuario_modificar_senha, { state: { id } });
    };
    ...
    const handleUpdateSubmit = async (e) => {
        ...
        try {
            const result = await axios.put(import.meta.env.VITE_API_URL_BACKEND + import.meta.env.VITE_API_URL_USUARIO + "/" + id, usuarioAtualizacao);
            ...
            toast.error('Erro ao tentar atualizar o usuário', error);
        }
        ...
        if (atualizacaoBemSucedida) {
            ...
            setFormNomeLogin("");
            setFormUnidadeFuncionalId("");
            setFormGerenteDeArea("");
        }
    };
        ...
        <MainLayout>
            <React.Fragment>
                ...
                <Actions breadcrumb="Início : Diversos"
                    nomeSessao="Atualização de Usuário" hasAddViewButton={false} hasFilter={false} />
                ...
                <FormPadrao onSubmit={handleUpdateSubmit}>
                    ...
                    <InternalButtonArea loading={loadingUsuarios}>
                        ...
                        <ButtonComponent tipo="primario" tipoBotao='button' desabilitado={atualizarDesabilitado} onClick={handleIrPaginaModificarSenha}>
