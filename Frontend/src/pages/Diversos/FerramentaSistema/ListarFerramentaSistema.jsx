...
const ListarFerramentaSistema = () => {
    ...
    // ----------------------------------------------------------------------------------------------  
    const urlBackendFerramentaSistema = import.meta.env.VITE_API_URL_BACKEND + import.meta.env.VITE_API_URL_FERRAMENTA_SISTEMA_DATAGRID;
    ...
    // ----------------------------------------------------------------------------------------------
    const { linhas, colunas, loading, error } = useFetchDatagrid(urlBackendFerramentaSistema);
    ...
    const handleIrPaginaCriarRegistro = () => {
        navegar(routes.diversos_ferramenta_sistema_criar);
    };

    const handleIrPaginaAtualizarRegistro = () => {
        const id = selectedId;
        navegar(routes.diversos_ferramenta_sistema_atualizar, { state: { id } });
    };

    const handleIrPaginaExcluirRegistro = () => {
        const id = selectedId
        navegar(routes.diversos_ferramenta_sistema_excluir, { state: { id } });
    };
        ...
        <MainLayout>
            <React.Fragment>
                ...
                <Actions breadcrumb="Início : Diversos"
                    nomeSessao="Listagem de Ferramentas de sistema" hasAddViewButton={false} hasFilter={false} />
...
export default ListarFerramentaSistema;