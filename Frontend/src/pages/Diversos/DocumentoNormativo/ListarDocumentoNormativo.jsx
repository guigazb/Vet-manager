...
const ListarDocumentoNormativo = () => {
    ...
    // ----------------------------------------------------------------------------------------------  
    const urlBackendDocumentoNormativo = import.meta.env.VITE_API_URL_BACKEND + import.meta.env.VITE_API_URL_DOCUMENTO_NORMATIVO_DATAGRID;
    ...
    // ----------------------------------------------------------------------------------------------
    const { linhas, colunas, loading, error } = useFetchDatagrid(urlBackendDocumentoNormativo);
    ...
    const handleIrPaginaCriarRegistro = () => {
        navegar(routes.diversos_documento_normativo_criar);
    };

    const handleIrPaginaAtualizarRegistro = () => {
        const id = selectedId;
        navegar(routes.diversos_documento_normativo_atualizar, { state: { id } });
    };

    const handleIrPaginaExcluirRegistro = () => {
        const id = selectedId
        navegar(routes.diversos_documento_normativo_excluir, { state: { id } });
    };
        ...
        <MainLayout>
            <React.Fragment>
                ...
                <Actions breadcrumb="Início : Diversos"
                    nomeSessao="Listagem de Documentos Normativos" hasAddViewButton={false} hasFilter={false} />
...
export default ListarDocumentoNormativo;