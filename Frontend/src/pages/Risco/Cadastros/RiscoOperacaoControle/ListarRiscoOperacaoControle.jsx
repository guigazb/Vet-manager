...
const ListarRiscoOperacaoControle = () => {
    ...
    // ----------------------------------------------------------------------------------------------
    const urlBackendOperacaoControle = import.meta.env.VITE_API_URL_BACKEND + import.meta.env.VITE_API_URL_RISCO_OPERACAO_CONTROLE + "/datagrid";
    ...
    // ----------------------------------------------------------------------------------------------
    const { linhas, colunas, loading, error } = useFetchDatagrid(urlBackendOperacaoControle);
    ...
    const handleIrPaginaCriarRegistro = () => {
        navegar(routes.risco_operacao_controle_criar);
    };

    const handleIrPaginaAtualizarRegistro = () => {
        const id = selectedId;
        navegar(routes.risco_operacao_controle_atualizar, { state: { id } });
    };

    const handleIrPaginaExcluirRegistro = () => {
        const id = selectedId
        navegar(routes.risco_operacao_controle_excluir, { state: { id } });
    };
    ...
    return (
        <MainLayout>
            <React.Fragment>
                ...
                <Actions breadcrumb="Início : Cadastro : Risco"
                    nomeSessao="Listagem das Operações de Controle de Risco" hasAddViewButton={false} hasFilter={false} />
...
export default ListarRiscoOperacaoControle;